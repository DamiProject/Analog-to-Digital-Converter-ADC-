classdef Meta < handle
    ...
    methods
        function obj = Meta(Name, Validator, DataType, Unit)
    ...
    methods (Access = private)
        ...
        function validateInput(obj, val)
            try
                ...
                newME = MException('Meta:ValidationFailed', ...
