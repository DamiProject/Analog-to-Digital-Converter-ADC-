classdef AGC < handle
    ...
    methods
        ...
        function [OutputAGCSignal, t, History] = GainControl(obj, Input)
            
            Input = Input(:); %Input Signal Into The AGC  
            Fs = obj.Parameters.getValue("Fs"); % Sampling Rate
            % Time and Signal Allocation
            N = length(Input);
            t = (0:N-1)' / Fs;
            ...
            Anf = obj.Parameters.getValue("Anf");
            ...
            EnvAttack = obj.Parameters.getValue("EnvAttack");
            ...
            EnvRelease = obj.Parameters.getValue("EnvRelease");
            % Pole of the Envelope/Level Detector Leaky Integrator -
            % Based on the Release Time Constant
            Pev_rel =  exp(-1 / (EnvRelease * Fs));

            % AGC Gain Attack Time Constant
            GainAttack = obj.Parameters.getValue("GainAttack");
            ...
            GainRelease = obj.Parameters.getValue("GainRelease");
            ...
            GateAttack = obj.Parameters.getValue("GateAttack");
            ...
            GateRelease = obj.Parameters.getValue("GateRelease"); 
            % Pole of the Noise Gate Gain Leaky Integrator Based -
